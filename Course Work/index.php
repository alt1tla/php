...
if (isset($_POST['add-post'])) {
    ...
    // распознование хэштега
    $hash_pattern = '/#([^\s#]+)/u';
    if (preg_match($hash_pattern, $post_description, $matches)) {
        $hashtag = $matches[1];
    }
    // если нет хэштега то хэштег -> no_hashtag
    if (!isset($hashtag)) {
        $hashtag = 'no_hashtag';
    }
    // проверка на наличие хэштега 
